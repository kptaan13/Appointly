...
<body style="font-family: Arial, sans-serif; background: #f4f4f4; margin: 0; padding: 20px;">
  <div style="max-width: 560px; margin: 0 auto; background: #fff; border-radius: 8px; overflow: hidden; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
    ...
    <div style="padding: 32px 24px;">
      ...
      <p style="color: #374151; font-size: 16px;">Your appointment has been confirmed. Here are the details:</p>
      <table style="width: 100%; border-collapse: collapse; margin: 24px 0;">
        ...
        <tr>
          ...
          <td style="padding: 12px 0; color: #111827; font-size: 14px;">${data.durationMin} minutes</td>
        </tr>
      </table>
      <div style="text-align: center; margin: 32px 0;">
        <a href="${data.clientOrigin}/dashboard" style="background: #2563eb; color: #fff; padding: 12px 32px; border-radius: 6px; text-decoration: none; font-size: 15px; font-weight: bold;">View My Bookings</a>
      </div>
      <p style="color: #6b7280; font-size: 13px;">Need to cancel? You can manage your bookings from your dashboard.</p>
    </div>
